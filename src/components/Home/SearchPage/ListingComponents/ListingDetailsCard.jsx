// src/components/ListingDetailsCard.js
...
const ListingDetailsCard = ({
  ...
  return (
      <section
        className="relative rounded-lg flex flex-col justify-center min-[375px]:mt-4 mt-10 w-full max-w-2xl"
        data-v0-t="card"
      >
        ...
        <div className="mt-[-1rem] ml-8 p-0">
            ...
            >
              <path
                d="M22.5 38L11.5 28.5L0.500007 38L0.5 0L22.5 -3.8466e-06L22.5 38Z"
                fill="white"
              />
            </svg>
          </div>
        ...
        <div className="bg-[#222] mt-[-14rem] max-[] p-4 flex flex-col justify-start gap-2 w-full z-0 rounded-xl">
          ...
          <h2 className="min-[375px]:text-2xl max-[375px]:text-xl max-[300px]:text-md font-semibold mb-2 max-[350px]:text-center">{title}</h2>
