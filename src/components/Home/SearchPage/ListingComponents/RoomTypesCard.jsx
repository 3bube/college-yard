        ...
        {filteredRoomTypes.map(room => (
          ...
          >
            ...
            <div className="relative z-10 ">
              <div className="text-black font-semibold flex flex-col gap-1">
                <span className='bg-[#A3FE35] w-[100px] text-lg'>{room.price}</span>
                <span className='bg-[#A3FE35] w-[115px] text-xl'>PER YEAR</span>
              </div>
